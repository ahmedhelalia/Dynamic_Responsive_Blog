...
// fetch featured post from data base
$featured_query = "SELECT * FROM `posts` WHERE `is_featured` = 1";
$featured_result = mysqli_query($conn,$featured_query);
$featured_post = mysqli_fetch_assoc($featured_result);

// fetch 9 posts from posts 
$sql = "SELECT * FROM `posts` ORDER BY `date_time` DESC LIMIT 9";
    ...
    <section class="featured">
        <div class="container featured__container">
            ...
            <div class="post__info">
                ...
                <p class="post__body">
                     <?= substr($featured_post['body'] ,0,500)?>...
                </p>
...
<!--     ============================ END OF FEATURED ====================================-->
    ...
    <section class="posts <?= $featured_post ? '' : 'section_extra_margin' ?>">
